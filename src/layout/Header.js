                                    ...
                                    <div id="news-flash" className="d-inline-block">
                                        <ul>
                                            {newsItems.map((item, index) => (
                                                <li key={index} className={index === activeIndex ? 'fade-in' : 'fade-out'}>
                                                    {item}
                                                </li>
                                            ))}
                                        </ul>
                        ...
                        <div className="header-wrap">
                            ...
                            <div className="header-right">
                                {/* <div className="search-style-2">
                                    <form action="#">
                                        <select className="select-active">
                                            ...
                                            <option>EYE GLASSES</option>
                                            <option>SCREEN GLASSES</option>
                                ...
                                <div className="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                                    <nav>
                                        <ul>
                                            {/* <li className="hot-deals"><img src="assets/imgs/theme/icons/icon-hot.svg" alt="hot deals" /><a href="javascript:void(0)">Deals</a></li> */}
                                            {/* <li>
