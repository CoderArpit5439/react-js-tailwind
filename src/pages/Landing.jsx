            ...
            <div className="section-title">
              <div className="title">
                ...
                <ul className="list-inline nav nav-tabs links">
                  <li className="list-inline-item nav-item"><a className="nav-link" href="javascript:void(0)">Full Rim</a></li>
                  <li className="list-inline-item nav-item"><a className="nav-link" href="javascript:void(0)">Half Rim</a></li>
                  <li className="list-inline-item nav-item"><a className="nav-link" href="javascript:void(0)">Rimless</a></li>
                </ul>
              </div>
                  ...
                  <div className="col-lg-1-5 col-md-4 col-12 col-sm-6">
                    <div className="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".4s">
                      ...
                      <div className="product-content-wrap">
                        ...
                        <h2><a href="shop-product-right.html">Foster Farms Takeout Crispy classNameic Buffalo Wings</a></h2>
                        <div className="product-rate-cover">
                          <div className="product-rate d-inline-block">
                            <div className="product-rating" style={{ width: "90%" }}></div>
                          </div>
                    ...
                    <div className="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                      ...
                      <div className="product-content-wrap">
                        ...
                        <div className="product-card-bottom">
                          ...
                          <div className="add-cart">
                            <a className="add" href="shop-cart.html"><i class="fi-rs-shopping-cart mr-5"></i>Add </a>
                          </div>
                        </div>
                      </div>
                    </div>
